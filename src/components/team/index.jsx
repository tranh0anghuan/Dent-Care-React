...
function Team() {
  return (
    ...
    <div className="container">
        ...
        <div className="col-lg-4 ">
            <a href="dentist.html">
            </a><div className="team-item"><a href="dentist.html">
            </a><div className="position-relative rounded-top" style={{zIndex: 1}}><a href="dentist.html">
                <img className="img-fluid rounded-top w-100" src="/team-1.jpg" alt />
                </a><div className="position-absolute top-100 start-50 translate-middle bg-light rounded p-2 d-flex"><a href="dentist.html">
                </a><a className="btn btn-primary btn-square m-1" href="#"><i className="fab fa-twitter fw-normal" /></a>
