...
function Footer() {
  return (
    <div>
  {/* Newsletter Start */}
  <div className="container-fluid position-relative pt-5 " style={{zIndex: 1, top:'80px'}}>
      ...
      <div className="row g-5 pt-4">
        <div className="col-lg-3 col-md-6">
          ...
          <div className="d-flex flex-column justify-content-start">
            <Link className="text-light mb-2 text-decoration-none" to={"/"}><i className="bi bi-arrow-right text-primary me-2" />Home</Link>
            <Link className="text-light mb-2 text-decoration-none" to={"/"}><i className="bi bi-arrow-right text-primary me-2" />About Us</Link>
            <Link className="text-light mb-2 text-decoration-none" to={"/"}><i className="bi bi-arrow-right text-primary me-2" />Our Services</Link>
            <Link className="text-light mb-2 text-decoration-none" to={"/"}><i className="bi bi-arrow-right text-primary me-2" />Latest Blog</Link>
            <Link className="text-light text-decoration-none" to={"/"}><i className="bi bi-arrow-right text-primary me-2" />Contact Us</Link>
          </div>
        </div>
        <div className="col-lg-3 col-md-6">
