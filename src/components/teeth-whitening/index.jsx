    ...
    <>
      ...
      <div className="container" id="contain1">
        <div className="row g-5">
          ...
          <p>Teeth whitening is a popular cosmetic dental procedure aimed at restoring and enhancing the brightness of discolored teeth. It is an affordable and simple solution, considered one of the most effective ways to achieve a bright, white smile. However, some believe that teeth whitening can damage tooth enamel. Let's delve into this method with Kim Dental in the following article.</p>
          
          <div className="row" id="teeth">
            <h1>What is Teeth Whitening?</h1>
            <p>Teeth whitening involves using compounds combined with light energy to create an oxidation reaction that breaks down color molecules in the dentin. This process whitens the teeth beyond their natural color without harming the tooth surface or its internal components.</p>
            <p>Today, teeth whitening is widely used, especially for yellow teeth caused by factors such as:</p>
            ...
            <p>Currently, the two most popular methods are <strong>at-home teeth whitening</strong> and <strong>in-office teeth whitening</strong>. Each has its own set of advantages and disadvantages:</p>
            
            <h3>At-home Teeth Whitening</h3>
            <p>In this method, a dentist takes an impression of your teeth to create a custom-fit plastic tray that holds the whitening gel and prevents saliva from diluting the gel.</p>
            <ul id="ul">
